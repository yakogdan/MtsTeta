...
class MovieListRepoImpl : MovieListRepository {

    override suspend fun getMovieGenres(): Flow<List<MovieGenresDomainEntity>> = flowOf(
        listOf(
            MovieGenresDomainEntity(title = "боевики"),
            MovieGenresDomainEntity(title = "драмы"),
            MovieGenresDomainEntity(title = "комедии"),
            MovieGenresDomainEntity(title = "артхаус"),
            MovieGenresDomainEntity(title = "мелодрамы"),
            MovieGenresDomainEntity(title = "ужасы"),
            MovieGenresDomainEntity(title = "фантастика"),
            MovieGenresDomainEntity(title = "документальные")
        )
    )

    override suspend fun getMovieCards(): Flow<List<MovieCardDomainEntity>> = flowOf(
        listOf(
